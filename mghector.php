...
<div class="breadcrumb-wrapper bg-cover" style="background-image: url('img/bg-header-banner.jpg');">
            <div class="container">
                <div class="page-heading">
                    ...
                    <h1 class="wow fadeInUp" data-wow-delay=".5s">Car-Details</h1>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="icon-details-area">
                                        ...
                                        <div class="icon-details-main-items">
                                            <div class="icon-items">
                                                <div class="icon">
                                                    <img src="img/car/icon/07.png" alt="img">
                                                </div>
                                                <div class="content">
                                                    <h6>body:</h6>
                                                    <p>Sedan</p>
                                        ...
                                        <div class="icon-details-main-items">
                                            <div class="icon-items">
                                                <div class="icon">
                                                    <img src="img/car/door.svg" alt="img">
                                                </div>
                                                <div class="content">
                                                    <h6>Passengers:</h6>
                                                    <p>6 Seats</p>
                                            ...
                                            <div class="icon-items">
                                                <div class="icon">
                                                    <img src="img/car/seat.svg" alt="img">
                                                </div>
                                                <div class="content">
                                                    <h6>Gear:</h6>
                                                    <p>Automatic</p>
                                            ...
                                            <div class="icon-items">
                                                <div class="icon">
                                                    <img src="img/car/automatic.svg" alt="img">
                                                </div>
                                                <div class="content">
                                                    <h6>Gear:</h6>
                                                    <p>Automatic</p>
                                            ...
                                            <div class="icon-items">
                                                <div class="icon">
                                                    <img src="img/car/petrol.svg" alt="img">
                                                </div>
                                                <div class="content">
                                                    <h6>Fuel:</h6>
                                                    <p>Petrol</p>
...
<div class="car-item">
    <a href="mitshuishi.php">
        <img src="img/Cars/mitsubhi.jpg" alt="mitsubhisi">
        <div class="details">
           Mitsubishi
        </div>
        <div class="rate">1200/day</div>
